...
!
! Other Requirements
!     The user must provide a FUNCTION CCHI(X) which evalutes 
! Chi-squared (un-normalised) given the vector X.
!
! History
!     D. S. Sivia    9 Feb 1995  Initial release.
!     D. S. Sivia   21 Nov 1995  Corrected a minor, but crashable, bug.
!     D. S. Sivia   26 Apr 1996  Removed chi-squared write statements.
!
!-----------------------------------------------------------------------
!
